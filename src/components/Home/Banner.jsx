            ...
            <div className="hero-content flex-col lg:flex-row w-full max-w-7xl px-4 py-12 relative z-10">
                ...
                <div className="lg:w-1/2 text-white space-y-6">
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        <Link
                            to="/allProducts"
                            className="btn bg-white text-purple-600 hover:bg-gray-100 border-none px-8 py-3 text-lg font-semibold shadow-xl"
                        >
                            All Products
                        </Link>
                        ...
                        <Link
                            ...
                            className="btn btn-outline text-white border-white hover:bg-white hover:text-purple-600 px-8 py-3 text-lg font-semibold"
                        >
                            Add Export
                        </Link>
                    </div>
