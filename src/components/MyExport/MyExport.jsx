        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">Loading your exports...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50 py-8 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">My Exports</h1>
                    <p className="text-gray-600">Manage your export products</p>
                </div>
                ...
                {product.length === 0 ? (
                    <div className="text-center py-12 bg-white rounded-lg shadow">
                        ...
                        <p className="text-gray-600 mb-4">Start by adding your first export product</p>
                        <Link 
                            to="/addExport"
