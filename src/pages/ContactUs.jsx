                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:support@exportimporthub.com" className="text-purple-600 hover:text-purple-700 text-sm">
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+1234567890" className="text-blue-600 hover:text-blue-700 text-sm">
                                        +1 (234) 567-890
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6">
                            ...
                            <div className="flex gap-3">
                                <a href="#" className="bg-white p-2 rounded-lg shadow hover:shadow-md transition-shadow">
