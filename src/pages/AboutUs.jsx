        ...
        <div className="min-h-screen bg-base-200">
            ...
            <div className="bg-gradient-to-r from-primary to-secondary text-primary-content py-20">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl md:text-2xl text-primary-content/80 max-w-3xl mx-auto">
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    {/* Mission */}
                    <div className="bg-base-100 rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300">
                        <div className="flex items-center mb-6">
                            ...
                            <h2 className="text-3xl font-bold text-base-content ml-4">Our Mission</h2>
                        </div>
                    ...
                    <div className="bg-base-100 rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300">
                        <div className="flex items-center mb-6">
                            ...
                            <h2 className="text-3xl font-bold text-base-content ml-4">Our Vision</h2>
                        </div>
                        <p className="text-base-content/70 text-lg leading-relaxed">
                ...
                {/* Our Story Section */}
                <div className="bg-base-100 rounded-3xl p-8 md:p-12 mb-16 shadow-lg">
                    <h2 className="text-3xl md:text-4xl font-bold text-base-content mb-6 text-center">Our Story</h2>
                ...
                {/* Values Section */}
                <div className="mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-base-content mb-12 text-center">Our Core Values</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {/* Value 1 */}
                        <div className="bg-base-100 rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
                            <div className="bg-primary w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                <span className="text-3xl">🤝</span>
                            </div>
                            <h3 className="text-xl font-bold text-base-content mb-2">Trust</h3>
                        ...
                        <div className="bg-base-100 rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
                            ...
                            <h3 className="text-xl font-bold text-base-content mb-2">Innovation</h3>
                            <p className="text-base-content/70">
                        ...
                        <div className="bg-base-100 rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
                            ...
                            <h3 className="text-xl font-bold text-base-content mb-2">Global Reach</h3>
                            <p className="text-base-content/70">
                        ...
                        <div className="bg-base-100 rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300">
                            ...
                            <h3 className="text-xl font-bold text-base-content mb-2">Quality</h3>
                            <p className="text-base-content/70">
                ...
                {/* Stats Section */}
                <div className="bg-gradient-to-r from-primary to-secondary rounded-3xl p-8 md:p-12 text-primary-content mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">Our Impact</h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="text-center">
                            <div className="text-4xl md:text-5xl font-bold mb-2">500+</div>
                            <div className="text-primary-content/80">Products Listed</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl md:text-5xl font-bold mb-2">50+</div>
                            <div className="text-primary-content/80">Countries</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl md:text-5xl font-bold mb-2">1000+</div>
                            <div className="text-primary-content/80">Active Traders</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl md:text-5xl font-bold mb-2">99%</div>
                            <div className="text-primary-content/80">Satisfaction Rate</div>
                        </div>
                    </div>
                </div>

                {/* CTA Section */}
                <div className="bg-base-100 rounded-3xl p-8 md:p-12 text-center shadow-lg">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                        ...
                        <Link to='/contact-us' className="btn btn-outline btn-primary px-8 py-3 text-lg font-semibold">
                            Contact Us
                        </Link>
                    </div>
                </div>
